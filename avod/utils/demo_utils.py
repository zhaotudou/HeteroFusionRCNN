...
def get_max_ious_3d(all_gt_boxes_3d, pred_boxes_3d):
    ...
    if pred_boxes_3d:
        ...
        gt_objs_iou_fmt = box_3d_encoder.box_3d_to_3d_iou_format(all_gt_boxes_3d)
        pred_objs_iou_fmt = box_3d_encoder.box_3d_to_3d_iou_format(pred_boxes_3d)
        ...
        for gt_obj_idx in range(len(all_gt_boxes_3d)):
            ...
            ious_3d = evaluation.three_d_iou(gt_obj_iou_fmt, pred_objs_iou_fmt)
...
def tf_project_to_image_space(anchors, calib_p2, image_shape, img_idx):
    ...
    projected_boxes_tensor, _ = anchor_projector.tf_project_to_image_space(
        anchors_tensor, calib_p2_tensor, image_shape_tensor
    )
    sess = tf.Session()
