...
class AnchorFilterTest(unittest.TestCase):
    def test_get_empty_anchor_filter_in_2d(self):
        ...
        area_extent = [(0.0, 2.0), (-1.0, 0.0), (0.0, 2.0)]
        ...
        boxes_3d = np.array(
            [
                [0.51, 0, 0.51, 1, 1, 1, 0],
                [0.51, 0, 0.51, 1, 1, 1, np.pi / 2.0],
                [0.51, 0, 1.1, 1, 1, 1, 0],
                [0.51, 0, 1.1, 1, 1, 1, np.pi / 2.0],
                [1.51, 0, 0.51, 1, 1, 1, 0],
                [1.51, 0, 0.51, 1, 1, 1, np.pi / 2.0],
                [1.51, 0, 1.1, 1, 1, 1, 0],
                [1.51, 0, 1.1, 1, 1, 1, np.pi / 2.0],
            ]
        )
        ...
        gen_filter = anchor_filter.get_empty_anchor_filter(
            anchors, voxel_grid, density_threshold=1
        )

        expected_filter = np.array([False, False, True, True, False, False, True, True])
        ...
        boxes_3d = np.array(
            [
                ...
                [0.5, 0, 0.5, 2, 1, 1, np.pi / 2.0],
                [0.5, 0, 1.5, 1, 2, 1, 0],  # case 2
                [0.5, 0, 1.5, 1, 2, 1, np.pi / 2.0],
                [1.5, 0, 0.5, 2, 1, 1, 0],  # case 3
                [1.5, 0, 0.5, 2, 1, 1, np.pi / 2.0],
                [1.5, 0, 1.5, 1, 2, 1, 0],  # case 4
                [1.5, 0, 1.5, 1, 2, 1, np.pi / 2.0],
            ]
        )
        ...
        expected_filter = np.array([False, True, True, True, False, True, True, True])
