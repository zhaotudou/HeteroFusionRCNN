...
class BevSlices(bev_generator.BevGenerator):
    ...
    def generate_bev(self, source, point_cloud, ground_plane, area_extents, voxel_size):
        ...
        for slice_idx in range(self.num_slices):
            ...
            height_map = np.zeros(
                (voxel_grid_2d.num_divisions[0], voxel_grid_2d.num_divisions[2])
            )
