...
class Evaluator:
    ...
    def run_checkpoint_once(self, checkpoint_to_restore):
        ...
        if self.full_model:
            ...
            os.system("ln -s {} {}".format(prop_score_predictions_dir, self.model.dataset.proposal_dir))
            ...
            if validation:
                ...
                os.system("ln -s {} {}".format(prop_info_dir, self.model.dataset.proposal_info_dir))
