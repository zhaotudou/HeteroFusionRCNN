...
from hf.datasets.kitti.kitti_utils import KittiUtils
...
class KittiDataset:
    def __init__(self, dataset_config):
        ...
        # Determines if training includes all samples
    ...
    def load_rpn_samples(self, indices, pc_sample_pts=16384, img_w=1200, img_h=360):
...
def main():
    ...
    # Defaults
    default_pipeline_config_path = hf.root_dir() + "/configs/rcnn_cars.config"
