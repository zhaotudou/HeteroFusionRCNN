...
def do_preprocessing(dataset, indices):
    ...
    label_seg_utils = dataset.kitti_utils.label_seg_utils

    print("Generating label segs in {}".format(
        label_seg_utils.label_seg_dir))

    # Generate all mini-batches, this can take a long time
    label_seg_utils.preprocess_rpn_label_segs(indices)

    print("Label segs generated")
...
def main(dataset=None):
    ...
    car_dataset_config_path = avod.root_dir() + \
        '/configs/label_seg_preprocessing/rpn_cars.config'
    ped_dataset_config_path = avod.root_dir() + \
        '/configs/label_seg_preprocessing/rpn_pedestrians.config'
    cyc_dataset_config_path = avod.root_dir() + \
        '/configs/label_seg_preprocessing/rpn_cyclists.config'
    ppl_dataset_config_path = avod.root_dir() + \
        '/configs/label_seg_preprocessing/rpn_people.config'
