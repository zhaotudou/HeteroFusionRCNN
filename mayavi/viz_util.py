...
def draw_lidar_simple(pc, color=None):
    ...
    mlab.view(azimuth=180, elevation=70, focalpoint=[ 12.0909996 , -1.04700089, -2.03249991], distance=90.0, figure=fig)
    return fig
...
def draw_lidar(pc, color=None, fig=None, bgcolor=(0,0,0), pts_scale=1, pts_mode='point', pts_color=None):
    ...
    z1 = TOP_Z_MIN
    z2 = TOP_Z_MAX
    mlab.plot3d([x1, x1], [0,0], [z1, z2], color=(0.5,0.5,0.5), tube_radius=0.1, line_width=1, figure=fig)
    mlab.plot3d([x2, x2], [0,0], [z1, z2], color=(0.5,0.5,0.5), tube_radius=0.1, line_width=1, figure=fig)
    mlab.plot3d([x1, x2], [0,0], [z1, z1], color=(0.5,0.5,0.5), tube_radius=0.1, line_width=1, figure=fig)
    mlab.plot3d([x1, x2], [0,0], [z2, z2], color=(0.5,0.5,0.5), tube_radius=0.1, line_width=1, figure=fig)
    
    mlab.orientation_axes()
    mlab.view(azimuth=270, elevation=120, focalpoint=[ 1.04700089, 2.03249991, 12.0909996], distance=60.0, figure=fig)
    return fig
